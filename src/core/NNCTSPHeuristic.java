 ...
 *
 */
public class NNCTSPHeuristic implements TSPHeuristic, RandomizedHeuristic {
	 ...
	 * @param distances
	 */
	public NNCTSPHeuristic(DistanceMatrix distances, ArrayList<Double> demands, double Q){
		this.Q = Q;
