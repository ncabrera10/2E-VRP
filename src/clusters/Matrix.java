...
import static clusters.Layout.COL_MAJOR;
import static clusters.Layout.ROW_MAJOR;
import static clusters.UPLO.LOWER;
import static clusters.UPLO.UPPER;
import static clusters.Transpose.TRANSPOSE;
import static clusters.Transpose.NO_TRANSPOSE;
import static clusters.Side.LEFT;
import static clusters.Side.RIGHT;
import static clusters.Diag.NON_UNIT;
...
public class Matrix extends IMatrix {
    ...
    public static Matrix column(double[] A, int offset, int length) {
        Matrix matrix = new Matrix(length, 1, length, new double[length]);
    ...
    public static Matrix row(double[] A, int offset, int length) {
        Matrix matrix = new Matrix(1, length, 1, new double[length]);
        System.arraycopy(A, offset, matrix.A, 0, length);
        return matrix;
    }
